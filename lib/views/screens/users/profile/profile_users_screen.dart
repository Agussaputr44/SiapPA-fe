...
class ProfileUsersScreen extends StatefulWidget {
  const ProfileUsersScreen({super.key});
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              elevation: 0, // no built-in shadow
                              backgroundColor: Colors.white,
      ...
      children: [
        ...
        Container(
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(12),
            border: Border.all(
              color: isEditable ? AppColors.primary : Colors.grey[300]!,
            ),
          ),
          child: TextField(
            ...
            decoration: InputDecoration(
              prefixIcon: Icon(
                icon,
                color: isEditable ? AppColors.primary : Colors.grey[400],
              ),
