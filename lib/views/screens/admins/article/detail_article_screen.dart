                              ...
                              child: GestureDetector(
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (_) => MediaPreviewWidget(url: imageUrl),
                                    ),
                                  );
                                },
                                child: ClipRRect(
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          ...
                          if (confirm == true) {
                            ...
                            if (articleId == null) {
                              MessagesWidget.showError(context, "ID artikel tidak ditemukan.");
                              return;
                            }
                            await context.read<ArticlesProvider>().deleteArticle(articleId);
                            final error = context.read<ArticlesProvider>().errorMessage;
                            if (error != null) {
                              MessagesWidget.showError(context, error);
                            } else {
                              MessagesWidget.showSuccess(context, "Artikel berhasil dihapus.");
